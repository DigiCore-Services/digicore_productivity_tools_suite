...
- [ ] PHASE 38: Structured Data Export (CSV/JSON)
    - [ ] Extend `ExtractionResult` with structured data model
    - [ ] Generate `.csv` and `.json` artifacts in results folder

- [ ] PHASE 39: OCR Confidence Heatmaps
    - [ ] Capture `OcrWord.Confidence` from Windows API
    - [ ] Implement amber/red underlining in HTML "Raw Output" pane
