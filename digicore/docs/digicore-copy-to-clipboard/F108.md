...
- [ ] Implement Structural Merger for adjacent table blocks
- [ ] Add column consensus check for block reconciliation
- [ ] Verify merging on multi-segment table samples

### PHASE 49: Semantic Entity Tagging (PII & Data Keys)
- [ ] Implement Regex/Pattern matching for Emails, Dates, and Currency
- [ ] Add semantic metadata layer to `ExtractionResult`
- [ ] Update HTML reports with data-type highlighting

### PHASE 50: Dashboard "Elite" UX Polish
- [ ] Implement Glassmorphism and Backdrop Blur for cards
- [ ] Enhance Performance Pulse with smooth SVG transitions
- [ ] Add "Actionable Leaderboard" auto-scroll logic
