...
- [/] Phase 46: Multi-Run "Timeline" Performance Tracking
    - [/] Design `history.json` schema (Timestamp, Accuracy, Latency, Entropy)
    - [ ] Implement historical data persistence in regression suite
    - [ ] Generate "Performance Pulse" sparklines in `summary.html`
