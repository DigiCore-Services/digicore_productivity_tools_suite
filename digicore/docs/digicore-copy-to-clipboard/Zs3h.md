...
- [/] Phase 44: Structural Confidence & Uncertainty Highlighting
    - [ ] Calculate "Word Jitter" (Alignment deviation score)
    - [ ] Implement Structural Confidence Score (0-100%)
    - [ ] Update `ExtractionResult` metadata with confidence map
    - [ ] Update HTML reports with amber/red underlines for low confidence
- [ ] Phase 45: Layout-Aware Header Detection (Hierarchical Markdown)
    - [ ] Calculate "Relative Font Height" (Height vs Doc Average)
    - [ ] Detect centered/hero primary text as Headers
    - [ ] Inject `#`, `##` into Markdown reconstruction
