...
- [x] PHASE 40: Heuristic Refinement & Bug Fixes
    - [x] Fix False Positive Table Detection (Example 10)
    - [x] Fix Merged Columns in tight layouts (Example 3 Gender column)
...
- [ ] Phase 43: Adaptive OCR Tuning (Per-Document Heuristics)
    - [ ] Implement Document Classifier (use Entropy & Density)
    - [ ] Define specialized `HeuristicConfig` presets
    - [ ] Implement two-pass/adaptive configuration selection logic
    - [ ] Update regression reports to show selected adaptive profile
    - [ ] Add new complex test cases to verify adaptive switching
