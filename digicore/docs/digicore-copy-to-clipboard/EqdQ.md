...
- [ ] Implement capture-to-corpus backend hook
- [ ] Add developer hotkey handler in application layer
- [ ] Auto-generate "Baseline" snapshot for new samples

### PHASE 53: Advanced Table Semantics & Export
- [ ] Detect Table Header vs Body vs Footer structures
- [ ] Implement direct-to-Excel/Parquet structured export
- [ ] Add "Table Accuracy" metric to regression suite
