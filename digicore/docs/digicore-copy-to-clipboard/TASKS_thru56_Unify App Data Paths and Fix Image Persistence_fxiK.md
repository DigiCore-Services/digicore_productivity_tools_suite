...
- [ ] Generate/Update `README_...md` files (e.g., Corpus, Core features)
- [ ] Generate `architecture.md` with Mermaid diagrams
- [ ] Generate `use_cases.md` with Mermaid diagrams
- [ ] Generate `requirements_spec.md` with Mermaid diagrams
- [ ] Review and refine embedded visual diagrams for all markdown output
