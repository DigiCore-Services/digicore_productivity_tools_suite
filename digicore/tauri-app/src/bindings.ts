...
export type SkillMetadataDto = { name: string; description: string; version: string; author: string | null; tags: string[] }

export type SkillDto = { metadata: SkillMetadataDto; instructions: string | null; resources: string[]; path: string | null }
...
export type Router = {
    "": {
        ...
        kms_save_skill: (skill: SkillDto) => Promise<null>,
