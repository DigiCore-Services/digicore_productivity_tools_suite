...
export type CopyToClipboardConfigDto = { enabled: boolean; min_log_length: number; mask_cc: boolean; mask_ssn: boolean; mask_email: boolean; blacklist_processes: string; max_history_entries: number; json_output_enabled: boolean; json_output_dir: string; image_storage_dir: string }
