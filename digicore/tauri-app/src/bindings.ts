...
export type GhostFollowerStateDto = {
    enabled: boolean; pinned: PinnedSnippetDto[]; search_filter: string; mode: string; expand_trigger: string; expand_delay_ms: number; clipboard_depth: number;
    /**
...
export type SkillDto = { metadata: SkillMetadataDto; instructions: string | null; resources: SkillResourceDto[]; path: string | null }
