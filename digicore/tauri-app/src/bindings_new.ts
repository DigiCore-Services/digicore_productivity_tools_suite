...
export type KmsEdgeDto = { source: string; target: string }
...
export type KmsGraphDto = { nodes: KmsNodeDto[]; edges: KmsEdgeDto[]; cluster_labels: KmsClusterLabelDto[]; ai_beams: KmsAiBeamDto[] }
...
export type KmsNoteDto = { id: number; path: string; title: string; preview: string | null; last_modified: string | null; is_favorite: boolean; sync_status: string; node_type: string; folder_path: string }
...
kms_get_graph: () => Promise<KmsGraphDto>, 
